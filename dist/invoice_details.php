  ...
  window.location.href = url;
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2024 Jayasri. All rights reserved. <a href="#"> Terms of use</a><a href="#">Privacy Policy</a></span>
