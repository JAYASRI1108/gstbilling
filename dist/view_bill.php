      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row mb-4">
              <div class="col-md-12">
                <!-- Add Goods button removed for final bill view -->
                <!-- Rate Details/Action buttons removed for final bill view -->
                <button type="button" class="btn btn-danger ms-2" id="printInvoiceBtn">Print</button>
            <script>
            document.addEventListener('DOMContentLoaded', function() {
              // Print Invoice Button only
            ...
            <!-- Add Goods Modal removed for final bill view -->
            <script>
            ...
            <!-- Goods Rate Details Modal removed for final bill view -->
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2025Jayasri. All rights reserved. <a href="#"> Terms of use</a><a href="#">Privacy Policy</a></span>
